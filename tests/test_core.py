...
from coreagent import Agent, LLM, Config, ALL_TOOLS, __version__
from coreagent import session as session_module
from coreagent.context import ContextManager, estimate_tokens
from coreagent.session import save_session, load_session, list_sessions
from coreagent.tools import get_tool
...
def test_config_from_env(monkeypatch):
    monkeypatch.setenv("COREAGENT_MODEL", "test-model")
    c = Config.from_env()
...
def test_edit_tracks_changed_files(tmp_path):
    from coreagent.tools.edit import _changed_files
